 ...
 */
public class RvSocalNewsAdapter extends RecyclerView.Adapter<RvSocalNewsAdapter.ViewHolder> {

    private Context mContext;
    private List<SocalNewsBean.NewslistBean> dataList = new LinkedList<>();

    public void addAllData(SocalNewsBean bean) {
    ...
    public RvSocalNewsAdapter(Context context) {
        mContext = context;
        //this.dataList.addAll(bean.getNewslist());
        notifyDataSetChanged();
    }
    ...
    @Override
    public void onBindViewHolder(RvSocalNewsAdapter.ViewHolder holder, final int position) {
